"""Alembic env (async). Работаем строго в схеме db_schema (maria_doll) — чужие таблицы не трогаем."""
...
def do_run_migrations(connection: Connection) -> None:
    ...
    # Размещение таблиц в нашей схеме обеспечивает search_path из server_settings.
